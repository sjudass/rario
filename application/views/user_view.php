...
<div class="row" style="width: 100%">
    ...
    <?php if (isset($getuser)) foreach ($getuser as $user):?>
    <form method="post" action="/admin/user/<?= $user['id'];?>" class="col-sm-9">
        <div class="col-md-12">
            <div class="row">
                    <div class="form-group col-sm-6 contact-form">
                        ...
                        <input type="text" name="middle_name" class="form-control" id="middle_name" value="<?= $user['middle_name'];?>">
                    </div>
                    <div class="form-group col-sm-6 contact-form">
                        ...
                        <input type="text" name="position" class="form-control" id="position" value="<?= $user['position'];?>" required>
                    </div>
