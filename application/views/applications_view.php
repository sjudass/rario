                ...
                <tr>
                    ...
                    <td style="width: 50px">
                        <?php if ($application['status'] == "Выполнена") :?>
                            <a href="/admin/application/<?= $application['id'];?>" class="btn btn-dark btn-lg pull-right button-submit" style="width: 106px;">Просмотр</a>
                        <?php else:?>
                            <a href="/admin/application/<?= $application['id'];?>" class="btn btn-dark btn-lg pull-right button-submit">Редактировать</a>
                        <?php endif;?>
                    </td>
                    <td style="width: 30px">
                        <a href="/admin/deleteapplication/<?= $application['id'];?>" class="btn btn-dark btn-lg pull-right button-submit">Удалить</a>
                    </td>
                </tr>
            <?php endforeach;}?>
